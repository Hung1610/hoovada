...
msg_create_failed = 'Không thể tạo bài viết. Vui lòng liên hệ admin để khắc phục.'
...
msg_article_not_found_with_id = 'Không thể tìm thấy bài viết với ID: {}'
...
msg_article_not_found = 'Không thể tìm thấy bài viết.'
