...
from app.modules.article.comment.favorite.favorite_controller import \
    ArticleCommentFavoriteController
# own modules
...
_vote_get_params = ArticleCommentFavoriteDto.model_get_parser
