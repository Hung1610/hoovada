...
class ArticleDto(Dto):
    ...
    model_get_parser.add_argument('topic_ids', type=str, required=False, action='append', help='Search all articles from the list of topic ids')
    model_get_parser.add_argument('article_ids', type=str, required=False, action='append', help='Search all articles from the list of article ids')
