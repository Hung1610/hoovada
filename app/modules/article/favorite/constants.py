...
# # Create Messages
msg_create_success = 'Yêu thích được tạo thành công.'
...
msg_create_failed = 'Yêu thích tạo thất bại'
msg_already_favorited = 'Đã yêu thích sẵn.'

# # Get Messages
msg_get_all_failed = 'Không thể lấy bài viết. Vui lòng liên hệ admin để khắc phục.'
msg_lacking_id = 'Vui lòng cung cấp ID của đánh giá!'

# # Get Single/Update Messages
msg_vote_not_found_with_id = 'Không thể tìm thấy đánh giá với ID: {}'
...
# # Delete Messages
msg_delete_success_with_id = 'Yêu thích với ID {} đã được xóa thành công.'
msg_delete_failed = 'Không thể xóa yêu thích'
...
msg_article_favorite_not_found = 'Không thể tìm thấy yêu thích.'
