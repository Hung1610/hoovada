...
class SearchDto(Dto):
    ...
    search_topic_request_parser.add_argument('is_fixed', type=bool, required=False, help='Set 1 to get only fixed_topic, 0 to get only non fixed_topic, do not set to get all')
