...
class PollCommentReportDto(Dto):
    name = 'poll_comment_report'
    api = Namespace(name, description="Poll comment report operations")

    model_request = api.model('poll_comment_report_request', {
        'report_type': fields.String(description='1 - General, 2 - Inappropriate, 3 - Duplicate', default=1),
        'description': fields.String(description=''),
    })

    model_response = api.model('poll_comment_report_response', {
    ...
    get_parser.add_argument('comment_id', type=str, required=False, help='Search all reports by poll_id.')
