...
class PollCommentFavoriteDto(Dto):
    name = 'poll_comment_favorite'
    api = Namespace(name, description="Post comment favorite operations")

    model_favorite_poll_comment = api.model('favorite_poll_comment', {
        'title': fields.String(description='The title of the poll_comment'),
        'user_id': fields.Integer(description='The user information')
    })

    model_request = api.model('favorite_poll_comment_request', {
    })
    ...
    model_response = api.model('favorite_response', {
        ...
        'poll_comment_id': fields.Integer(required=False, description='The poll_comment ID which has been favorited'),
    ...
    model_get_parser.add_argument('favorited_user_id', type=str, required=False, help='Search favorites by user owner of the poll_comment')