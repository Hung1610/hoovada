...
# # Delete Messages
msg_delete_success_with_id = 'Đánh giá với ID {} đã được xóa thành công.'
msg_delete_failed = 'Không thể xóa đánh giá'
...
msg_vote_not_found = 'Không thể tìm thấy đánh giá.'
