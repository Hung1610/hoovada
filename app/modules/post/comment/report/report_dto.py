...
class PostCommentReportDto(Dto):
    ...
    model_response = api.model('post_comment_report_response', {
    ...
    get_parser.add_argument('comment_id', type=str, required=False, help='Search all reports by post_id.')
