...
class CommentReportDto(Dto):
    name = 'comment_report'
    api = Namespace(name, description="Comment report operations")

    model_request = api.model('comment_report_request', {
        'inappropriate': fields.Boolean(description=''),
        'description': fields.String(description='')
    })

    model_response = api.model('comment_report_response', {
