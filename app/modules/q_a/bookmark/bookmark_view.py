...
from app.modules.q_a.bookmark.bookmark_dto import QuestionBookmarkDto
from app.modules.q_a.bookmark.bookmark_controller import QuestionBookmarkController
...
class BookmarkQuestionAll(Resource):
    ...
    def get(self, question_id):
        ...
        return controller.get(question_id=None, args=args)
