...
class AnswerCommentFavoriteDto(Dto):
    name = 'answer_comment_favorite'
    api = Namespace(name, description="AnswerComment-Favorite operations")

    model_topic_answer_comment_favorite = api.model('topic_answer_comment_favorite', {
        'id': fields.Integer(readonly=True, description='The ID of the topic'),
        'name': fields.String(description='The name of the topic')
    })

    model_favorite_answer_comment = api.model('favorite_answer_comment', {
        'title': fields.String(description='The title of the answer_comment'),
        ...
        'topics': fields.List(fields.Nested(model_topic_answer_comment_favorite), description='The list of topics')
    })

    model_request = api.model('favorite_answer_comment_request', {
    })
    ...
    model_response = api.model('favorite_response', {
        ...
        'answer_comment_id': fields.Integer(required=False, description='The answer_comment ID which has been favorited'),
    ...
    model_get_parser.add_argument('favorited_user_id', type=str, required=False, help='Search favorites by user owner of the answer_comment')