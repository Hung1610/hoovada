...
# own modules
from app.modules.q_a.answer.comment.voting.vote import VotingStatusEnum
...
class AnswerCommentVoteDto(Dto):
    name = 'answer_comment_vote'
    api = Namespace(name, description="AnswerComment voting operations")

    model_request_comment = api.model('answer_vote_request_comment_vote', {
        'vote_status': fields.Integer(description='1 - Neutral, 2 - Upvote, 3 - Downvote', default=False)
    })

    model_response = api.model('answer_vote_response_comment_vote', {
