...
class QuestionFavoriteDto(Dto):
    name = 'question_favorite'
    api = Namespace(name, description="Question-Favorite operations")

    model_topic_question_favorite = api.model('topic_question_favorite', {
    ...
    model_request = api.model('favorite_question_request', {
    })
    ...
    model_get_parser.add_argument('favorited_user_id', type=str, required=False, help='Search favorites by user owner of the question')