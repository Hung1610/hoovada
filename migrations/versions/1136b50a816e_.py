...
Revision ID: 1136b50a816e
Revises: update_unique_answer
Create Date: 2021-01-11 23:11:19.463766
...
revision = '1136b50a816e'
down_revision = 'update_unique_answer'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('answer', 'is_deleted',
               ...
               server_default=sa.text('false'),
               existing_nullable=True)
    op.create_unique_constraint(None, 'answer', ['user_id', 'question_id'])
