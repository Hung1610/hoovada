...
Revision ID: 71f6c84e34d1
Revises: 9a86dcf1f05a
Create Date: 2021-01-08 11:22:53.518685
...
revision = '71f6c84e34d1'
down_revision = '9a86dcf1f05a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('answer', 'is_deleted',
               ...
               server_default=sa.text('false'),
               existing_nullable=True)
    op.alter_column('article', 'comment_count',
               existing_type=mysql.INTEGER(display_width=11),
               server_default='0',
               existing_nullable=True)
    op.alter_column('article', 'downvote_count',
               existing_type=mysql.INTEGER(display_width=11),
               server_default='0',
               existing_nullable=True)
    op.alter_column('article', 'favorite_count',
               existing_type=mysql.INTEGER(display_width=11),
               server_default='0',
               existing_nullable=True)
    ...
    op.alter_column('article', 'is_draft',
               ...
               server_default=sa.text('false'),
               existing_nullable=True)
    op.alter_column('article', 'share_count',
               existing_type=mysql.INTEGER(display_width=11),
               server_default='0',
               existing_nullable=True)
    op.alter_column('article', 'upvote_count',
               existing_type=mysql.INTEGER(display_width=11),
               server_default='0',
               existing_nullable=True)
    ...
    op.alter_column('question', 'upvote_count',
               ...
               server_default='0',
               existing_nullable=True)
    op.alter_column('question', 'views_count',
               existing_type=mysql.INTEGER(display_width=11),
               server_default='0',
               existing_nullable=True)
